...
setup(
    ...
    description='Controller configuration, sensor nodes and test nodes for the 6-DOF arm.',
    license='Apache-2.0',
    ...
    entry_points={
        'console_scripts': [
            ...
            'encoder_simulator  = robot_arm_control.encoder_simulator:main',
            'motor_diagnostics  = robot_arm_control.motor_diagnostics:main',
            'limit_switches     = robot_arm_control.limit_switches:main',
        ],
    },
)
